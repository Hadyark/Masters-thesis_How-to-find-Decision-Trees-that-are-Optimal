...
static PyObject *__pyx_f_12error_cython_discr_add2(PyObject *__pyx_v_tids, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_y, __Pyx_memviewslice __pyx_v_sensitive, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_p0;
  int __pyx_v_p1;
